...
%  your implementation is correct by verifying that we get the same cost
%  for the fixed debugging parameters.
%
%  Suggestion: We should implement the feedforward cost *without* regularization
...
%  Before we start implementing the neural network, you will first
...
%  Once our cost matches up with the given cost, we should proceed to implement the
...
%  After we have completed the completed, let's change the MaxIter to a larger
